...
describe('UserController', () => {
    ...
    describe('POST /users/register', () => {
        test('should create user with valid data', async () => {
            ...
            (mockUserService.register as jest.Mock)
                .mockResolvedValue({ id: 1, ...userData, passwordHash: '...' });
    ...
    describe('GET /users/:id', () => {
        test('should get user by id', async () => {
            (mockUserService.getUser as jest.Mock)
                .mockResolvedValue(userFixtures.john);
